...
namespace rtaNetworking.Streaming
{
    ...
    static class Screen
    {
        ...
        {
            return Screen.Snapshots(System.Windows.Forms.Screen.AllScreens[0].Bounds.Width, System.Windows.Forms.Screen.AllScreens[0].Bounds.Height, true);
        }
        ...
        public static IEnumerable<Image> Snapshots(int width,int height,bool showCursor)
        {
            ...
            Size size = new Size(System.Windows.Forms.Screen.AllScreens[0].Bounds.Width, System.Windows.Forms.Screen.AllScreens[0].Bounds.Height);
            ...
            while (true)
            {
                ...
                srcGraphics.CopyFromScreen(System.Windows.Forms.Screen.AllScreens[0].Bounds.X, System.Windows.Forms.Screen.AllScreens[0].Bounds.Y, 0, 0, size);
